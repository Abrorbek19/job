...
@extends('layout.main')
@section('title','About Gotto Job Portal')
@section('content')
      <main>
                ...
                <div class="row justify-content-center align-items-center">
                    ...
                    <div class="col-lg-5 col-12 mt-5 mt-lg-0">
                        <div class="about-image-wrap">
                            <img src="../assets/image/horizontal-shot-happy-mixed-race-females.jpg" class="about-image about-image-border-radius img-fluid" alt="">
